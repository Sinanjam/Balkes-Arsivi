...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        version.setText("1.7 • Kırmızı Beyaz Hafıza");
        version.setTextColor(Color.rgb(255, 205, 205));
        version.setTextSize(13);
        version.setGravity(Gravity.CENTER);
        version.setPadding(0, dp(16), 0, 0);
        content.addView(version, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
